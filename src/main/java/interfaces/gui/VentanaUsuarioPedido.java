...
public class VentanaUsuarioPedido extends javax.swing.JFrame {
    private Controlador controlador;
  
    public VentanaUsuarioPedido(Controlador controlador) {
    ...
    private void botonMiPerfilActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_botonMiPerfilActionPerformed
        VentanaUsuarioPedido ventana = new VentanaUsuarioPedido(controlador);
        ventana.setLocationRelativeTo(null);
        ventana.setVisible(true);
        this.dispose();  
